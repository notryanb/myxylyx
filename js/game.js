...
BasicGame.Game.prototype = {
  ...
  //   // add original sprite's velocity to the explosion
  ...
  setupBackground: function() {
    this.sea = this.add.tileSprite(0, 0, this.game.width, this.game.height, 'spacebg');
  ...
  setupPlayer: function() {
    ...
    // Sets the hitbox a little bit higher.
  ...
  //   this.enemyPool.createMultiple(100, 'greenEnemy');
  ...
  setupText: function() {
    ...
    this.scoreText = this.add.text(
      ...
      { font: '20px monospace', fill: '#fff', alight: 'center' }
    );
  ...
  //       shooter, target, this.game.height, this.rnd.integerInRange(
